...
import { Archive, ExternalLink, Gamepad2, Search, ShieldCheck, Sparkles, Users } from "lucide-react";
...
export default function FamilyCanonicalLesson({ lesson, studentId }: { lesson: LessonResponse; studentId: string }) {
  ...
  return <article className="space-y-6 pb-20 text-[#2F4731]">
    ...
    <section className="rounded-2xl border border-[#D9CFBC] bg-[#F0FDF4] p-5"><h2 className="font-bold">What the registrar will recognize</h2><p className="mt-1 text-sm leading-6 text-[#2F4731]/65">Credit is proposed from demonstrated concepts and completed work—not time spent or a worksheet checked off.</p></section>
  </article>;
}
