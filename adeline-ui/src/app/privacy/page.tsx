  ...
  return (
    <main className="min-h-screen bg-[#F8F2E7] px-5 py-10 text-[#2F4731] sm:px-8">
      <article className="mx-auto max-w-3xl rounded-[28px] border border-[#D6C7AF] bg-[#FFFDF7] p-6 shadow-[0_18px_50px_rgba(62,50,33,.08)] sm:p-10">
        ...
        <p className="mt-5 text-base leading-7 text-[#2F4731]/72">Dear Adeline is a family-directed learning service. A learner may begin a pending account, but a parent controls access for children under 13 and may review, correct, export, or request deletion of their child&rsquo;s personal information.</p>

        <div className="mt-9 space-y-8 text-sm leading-7">
          <section><h2 className="text-2xl font-bold">Information we collect</h2><p className="mt-2">Before approval for a learner under 13, we collect only the pending account and parent-contact information needed to request consent. We do not begin the learner&rsquo;s educational profile or personalized learning record until approval. After approval, or for a learner who is 13 or older, we collect only information needed to provide and secure the learning service: a learner name or display name, username, learning level, interests, parent contact and consent records when applicable, learning conversations, investigations, submitted work and evidence, mastery and transcript records, portfolio entries, and limited technical/security logs. We do not require precise location, government identifiers, biometric identifiers, advertising identifiers, or a child&rsquo;s phone number.</p></section>
